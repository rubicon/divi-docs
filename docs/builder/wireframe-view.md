...
source_url: "https://help.elegantthemes.com/en/articles/10469465"
---
...
Double-click an element's label in Wireframe View to rename it. Custom names carry over to the [Layers View](layers-view.md) panel and make complex pages much easier to navigate.

### Right-Click Menus

All [right-click menu](right-click-menus.md) operations are available in Wireframe View, so you can copy, paste, extend, lock, and delete elements without switching back to the visual canvas.
...
- **Combine with Layers View.** For maximum structural control, open the [Layers View](layers-view.md) panel while in Wireframe View. The two tools complement each other -- Wireframe shows the full-page layout while Layers provides a collapsible tree.
...
- [Layers View](layers-view.md) -- Tree-based element navigation panel
- [Visual Builder Interface](vb-interface.md) -- Full interface overview
- [Left Sidebar](left-sidebar.md) -- Where the Wireframe toggle lives
