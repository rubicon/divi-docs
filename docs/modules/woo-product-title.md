...
source_url: "https://www.elegantthemes.com/documentation/divi/the-divi-woo-product-title-module/"
---
...
<!-- TODO: Verify all Content tab settings for Woo Product Title module -->
...
<!-- TODO: Replace with proper screenshot -->
<!-- ![Woo Product Title Content tab settings](../assets/screenshots/modules/woo-product-title/settings-content.png){ loading=lazy } -->

### Design Tab

<!-- TODO: Verify all Design tab settings for Woo Product Title module -->
...
<!-- TODO: Replace with proper screenshot -->
<!-- ![Woo Product Title Design tab settings](../assets/screenshots/modules/woo-product-title/settings-design.png){ loading=lazy } -->

### Advanced Tab

<!-- TODO: Verify all Advanced tab settings for Woo Product Title module -->
...
```css
/* Style the Woo Product Title module */
.et_pb_wc_product_title {
...
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_wc_product_title' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Woo Product Title module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Woo Product Title module doesn't appear on the front end, verify that:
