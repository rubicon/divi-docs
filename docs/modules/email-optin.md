...
source_url: "https://www.elegantthemes.com/documentation/divi/newsletter/"
---

# Email Optin

The Email Optin module is a Divi 5 content element used in the Visual Builder.
...
<!-- TODO: Verify all Content tab settings for Email Optin module -->
...
<!-- TODO: Verify all Design tab settings for Email Optin module -->
...
<!-- TODO: Verify all Advanced tab settings for Email Optin module -->
...
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_email_optin' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Email Optin module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Email Optin module doesn't appear on the front end, verify that:
