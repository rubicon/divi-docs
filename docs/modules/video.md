...
category: modules
tags: ["modules", "media"]
related: ["audio", "video-slider"]
divi_version: "5.x"
last_updated: 2026-03-12
source_url: "https://www.elegantthemes.com/documentation/divi/video/"
---

# Video

The Video module is a Divi 5 content element used in the Visual Builder.
...
<!-- TODO: Verify all Content tab settings for Video module -->
...
<!-- TODO: Verify all Design tab settings for Video module -->
...
<!-- TODO: Verify all Advanced tab settings for Video module -->
...
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_video' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Video module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Video module doesn't appear on the front end, verify that:
