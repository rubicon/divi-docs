...
source_url: "https://www.elegantthemes.com/documentation/divi/the-divi-woo-checkout-billing-module/"
---
...
How to add, configure and customize the Divi Woo checkout billing module.

The Divi Woo Checkout Billing Module integrates seamlessly with WooCommerce on your WordPress website and captures a customer’s billing details. Add it to your checkout page template in the Theme Builder and customize it using Divi’s easy drag-and-drop design settings.
...
<!-- TODO: Verify all Content tab settings for Woo Checkout Billing module -->
...
<!-- TODO: Verify all Design tab settings for Woo Checkout Billing module -->
...
<!-- TODO: Verify all Advanced tab settings for Woo Checkout Billing module -->
...
```css
/* Style the Woo Checkout Billing module */
...
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_wc_checkout_billing' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Woo Checkout Billing module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Woo Checkout Billing module doesn't appear on the front end, verify that:
