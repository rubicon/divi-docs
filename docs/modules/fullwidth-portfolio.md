...
category: modules
tags: ["modules", "fullwidth", "portfolio"]
related: ["portfolio", "filterable-portfolio"]
divi_version: "5.x"
...
The Fullwidth Portfolio module is a Divi 5 content element used in the Visual Builder.
...
<!-- TODO: Verify all Content tab settings for Fullwidth Portfolio module -->
...
<!-- TODO: Verify all Design tab settings for Fullwidth Portfolio module -->
...
<!-- TODO: Verify all Advanced tab settings for Fullwidth Portfolio module -->
...
```css
/* Style the Fullwidth Portfolio module */
...
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_fullwidth_portfolio' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Fullwidth Portfolio module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Fullwidth Portfolio module doesn't appear on the front end, verify that:
