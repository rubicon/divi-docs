...
source_url: "https://www.elegantthemes.com/documentation/divi/audio/"
---

# Audio

The Audio module is a Divi 5 content element used in the Visual Builder.
...
<!-- TODO: Verify all Content tab settings for Audio module -->
...
<!-- TODO: Verify all Design tab settings for Audio module -->
...
<!-- TODO: Verify all Advanced tab settings for Audio module -->
...
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_audio' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Audio module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Audio module doesn't appear on the front end, verify that:
