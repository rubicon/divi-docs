...
source_url: "https://www.elegantthemes.com/documentation/divi/the-divi-woo-cross-sells-module/"
---
...
How to add, configure and customize the Divi Woo Cross Sells module.

The Divi Woo Cross Sells Module dynamically displays similar cross-linked products from your online shop to encourage your visitors to browse more items and add them to their cart. The practice of cross-selling products is when similar products are displayed next to the product a customer is viewing. It’s similar to the checkout line at a brick-and-mortar shop that places similar-priced objects in the checkout line to encourage impulse purchases. The Woo Cross Sell module pulls information from the Linked Products section of a product listing.
...
<!-- TODO: Verify all Content tab settings for Woo Cross Sells module -->
...
<!-- TODO: Verify all Design tab settings for Woo Cross Sells module -->
...
<!-- TODO: Verify all Advanced tab settings for Woo Cross Sells module -->
...
```css
/* Style the Woo Cross Sells module */
...
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_wc_cross_sells' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Woo Cross Sells module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Woo Cross Sells module doesn't appear on the front end, verify that:
