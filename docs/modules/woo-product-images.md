...
source_url: "https://www.elegantthemes.com/documentation/divi/the-divi-woo-product-images-module/"
---
...
<!-- TODO: Verify all Content tab settings for Woo Product Images module -->
...
<!-- TODO: Verify all Design tab settings for Woo Product Images module -->
...
<!-- TODO: Verify all Advanced tab settings for Woo Product Images module -->
...
```css
/* Style the Woo Product Images module */
.et_pb_wc_product_images {
...
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_wc_product_images' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Woo Product Images module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Woo Product Images module doesn't appear on the front end, verify that:
