...
category: modules
tags: ["modules"]
related: ["call-to-action", "icon"]
divi_version: "5.x"
last_updated: 2026-03-12
source_url: "https://www.elegantthemes.com/documentation/divi/button/"
---

# Button

The Button module is a Divi 5 content element used in the Visual Builder.
...
<!-- TODO: Verify all Content tab settings for Button module -->
...
<!-- TODO: Verify all Design tab settings for Button module -->
...
<!-- TODO: Verify all Advanced tab settings for Button module -->
...
```php
/* Filter the Button module output */
add_filter('et_module_shortcode_output', function($output, $render_slug) {
    if ('et_pb_et_pb_button' !== $render_slug) {
        return $output;
    }
...
1. **Basic Usage** — Add the Button module to any row in the Visual Builder and configure its settings.
...
!!! warning "Module Not Rendering"
    If the Button module doesn't appear on the front end, verify that:
