...
**Block identifier:** `divi/number-counter` — *Needs verification on current build*
...
|-----------|-----------|-------|
| Title | `attrs.title` | Label text above the animated number |
| Number | `attrs.number` | Target value the counter animates to |
| Percent Sign | `attrs.percent_sign` | Toggle percentage symbol display |

!!! tip "Module Selection Guidance"
    For animated number stats use Number Counter; for circular progress use Circle Counter; for horizontal bars use Bar Counter.
