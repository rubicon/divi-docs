...
description: "Divi 5 Background options group — color, gradient, image, video, pattern, and mask backgrounds with layering and blend modes."
...
!!! abstract "Quick Reference"
    **What it controls:** Color, gradient, image, video, pattern, and mask backgrounds with layering and blend modes
    **Where to find it:** Design Tab → Background
    **Available on:** All modules, sections, rows, and columns
    **Responsive:** Yes — each background type can be configured independently per breakpoint
    **ET Docs:** [Official documentation](https://help.elegantthemes.com/en/articles/10063358)
...
- [Gradient Builder](../builder/gradient-builder.md) — Create complex multi-stop gradients for backgrounds
- [Filters Options](filters.md) — Apply brightness, contrast, and saturation effects over backgrounds
- [Hero Module](../modules/hero.md) — Full-screen hero sections that rely heavily on background options
- [Slider Module](../modules/slider.md) — Slide backgrounds with images, gradients, and videos
