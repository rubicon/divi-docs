# External link check — 2026-06-22
...
| `https://help.elegantthemes.com/en/articles/13284097-semantic-elements-custom-html-wrappers-for-divi-5` | 429 | Too Many Requests | `docs/modules/the-breadcrumbs-module-in-divi-5.md:103`; `docs/modules/the-canvas-portal-module-in-divi-5.md:82`; `docs/modules/the-contact-form-7-styler-module-in-divi-5.md:99` |
...
| `https://help.elegantthemes.com/en/articles/13714462` | 429 | Too Many Requests | `docs/modules/before-after-image.md:21`; `docs/modules/before-after-image.md:43`; `docs/modules/before-after-image.md:62` |
...
| `https://intercom.help/elegantthemes/en/articles/10316106-the-divi-row` | 405 | Not Allowed | `docs/modules/the-breadcrumbs-module-in-divi-5.md:25`; `docs/modules/the-canvas-portal-module-in-divi-5.md:23`; `docs/modules/the-contact-form-7-styler-module-in-divi-5.md:27` |
| `https://intercom.help/elegantthemes/en/articles/9996489-the-divi-regular-section` | 405 | Not Allowed | `docs/modules/the-breadcrumbs-module-in-divi-5.md:23`; `docs/modules/the-canvas-portal-module-in-divi-5.md:21`; `docs/modules/the-contact-form-7-styler-module-in-divi-5.md:25` |
...
| `https://webaim.org/resources/contrastchecker/` | 403 | Forbidden | `docs/css-reference/relative-colors-hsl.md:189` |
