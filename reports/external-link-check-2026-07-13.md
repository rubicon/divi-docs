# External link check — 2026-07-13
...
| `https://www.elegantthemes.com/blog/divi-resources/how-to-create-text-badges-in-divi-5` | 429 | Too Many Requests | `docs/modules/text.md:293` |
...
| `https://www.elegantthemes.com/blog/theme-releases/five-new-modules` | 429 | Too Many Requests | `docs/builder/aspect-ratio-image-framing-and-image-presets-in-divi-5.md:41`; `docs/modules/the-breadcrumbs-module-in-divi-5.md:127`; `docs/modules/the-svg-module-in-divi-5.md:53`; `docs/modules/the-timeline-module-in-divi-5.md:51` |
